...
const THEMES = {
  ...
  candies: {
    ...
    emojis: {
      '#FF69B4': '🍬', // Pink Candy
      '#FFD700': '🍭', // Yellow Lollipop
      '#8A2BE2': '🍫', // Purple Chocolate
      '#00CED1': '🍩', // Cyan Donut
      '#FF4500': '🍪', // Orange Cookie
      '#ADFF2F': '🧁', // Green Cupcake
    },
  ...
  gems: {
    ...
    colors: ["#FF0000", "#00FF00", "#0000FF", "#FFFF00", "#FF00FF", "#00FFFF"],
    emojis: {
      '#FF0000': '♦️', // Red Diamond
      '#00FF00': '❇️', // Green Sparkle
      '#0000FF': '🔷', // Blue Diamond
      '#FFFF00': '🔶', // Orange Diamond
      '#FF00FF': '💜', // Purple Heart
      '#00FFFF': '💠', // Cyan Diamond
    },
